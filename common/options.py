...
TrainOptions = namedtuple('TrainOptions',
                          ['num_epochs', 'batch_size', 'print_every', 'use_gpu', 'optimizer', 'learning_rate',
                           'activation_function', 'loss_function', 'num_runs_per_setting', 'dropout_rate', 'bias',
                           'seed', 'deterministic', 'progress_detection_patience', 'progress_detection_min_delta',
                           'visualize'])
